...
public class Music_Activity extends AppCompatActivity implements View.OnClickListener{
    ArrayList<String> list;   //已下载音乐的名字列表，用来查找对应的音乐文件
    //进度条
    private static SeekBar sb;
    private static TextView tv_progress,tv_total,name_song;

    private MusicService.MusicControl musicControl;      //音乐的播放、暂停、继续
    private String name;               //音乐的名字
    ...
    class MyServiceConn implements ServiceConnection{
        ...
        public void onServiceConnected(ComponentName name, IBinder service){
            musicControl=(MusicService.MusicControl) service;    //连接服务，得到MusicControl对象
        }
        @Override
